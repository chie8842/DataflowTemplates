...
public final class HiveToBigQuery {
   ...
   * command-line.
   */
  public interface Options extends DataflowPipelineOptions, HadoopFileSystemOptions {
    ...
    @Description("comma separated names of the columns that are partitions in Hive table")
    ...
    @Description(
        "Create disposition to use for BigQuery. "
